...
import com.hynson.R;
import com.hynson.view.chart.BaseChartView;
import com.hynson.view.chart.CustomizedBloodChartView;
...
public class CustomBloodChartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_chart_bloodchart, null, false);
