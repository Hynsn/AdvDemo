 ...
 * 磁力吸附悬浮窗
 */
public class AlertMagnetView extends FrameLayout {
    ...
    public AlertMagnetView(Context context) {
        this(context, null);
    }

    public AlertMagnetView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AlertMagnetView(Context context, AttributeSet attrs, int defStyleAttr) {
